            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="panel-group checkout-page accordion scrollable" id="checkout-page">
                    <div id="payment-address" class="panel panel-default">
                        ...
                        <form action="/member.do?method=affirmUpdate" method="post">
                            <div <%--id="payment-address-content" class="panel-collapse collapse"--%>>
                            <div class="panel-body row">
                                <div class="col-md-6 col-sm-6" style="margin-left: 270px">
                                        <input type="hidden" name="id" value="${member.id}"/>
                                    <div class="form-group">
                                        <label for="name">会员名称 <span class="require">*</span></label><span style="color: red">${msg}</span>
                                        <input type="text" id="name" class="form-control" name="name" value="${member.name}">
                                    </div>
                                    <%-- <div class="form-group">
                                         <label for="password">密码 <span class="require">*</span></label>
                                          <input type="text" id="password" class="form-control" name="password" value="${m.password}">
                                     </div>--%>
                                        <div class="form-group">
                                            <label for="reallyName">真实名字 <span class="require">*</span></label>
                                            <input type="text" id="reallyName" class="form-control" name="reallyName" value="${member.reallyName}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="professsion" class="form-control" name="professsion" value="${member.professsion}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="question" class="form-control" name="question" value="${member.question}">
                                        </div>
                                        <div class="form-group">
                                            <label for="result">答案 <span class="require">*</span></label>
                                            <input type="text" id="result" class="form-control" name="result" value="${member.result}">
                                        </div>
                                </div>
                                <hr>
                                <div class="col-md-12">
                                    <button class="btn btn-primary  pull-right" type="submit" data-toggle="collapse" data-parent="#checkout-page" data-target="#shipping-address-content" id="button-payment-address" style="background-color: #FF5757;width: 120px">提交</button>
