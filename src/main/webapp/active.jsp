                ...
                <div class="container-fluid" style="padding-left:100px;padding-top:17px">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/product?method=active" style="color: #00BC93;font-weight: 600;">活动</a>
                            </li>
                            <li>
    ...
    <div class="seckill">
        ...
        <div class="container">
            <div class="seckill-banner" >
                <div class="container relative" style="width:1100px;">
                    <ul>
...
*/
    ...
    document.addEventListener("scroll",function(){
        if(window.pageYOffset >=240){
            ...
            slidebar.style.top = "70px";
            slidebar.style.zIndex = "99";
        }else{
            slidebar.style.position = "absolute";
            slidebar.style.top ="";
            slidebar.style.zIndex = "";
        }
